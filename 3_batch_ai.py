...
koordinat_map = {
    ...
    "pkor.png": [105.2740, -5.3870, 105.2770, -5.3840], # Way Halim
    "masjid_airan.png": [105.3050, -5.3620, 105.3080, -5.3600], # Arah ITERA
    "jalan_ryacudu.png": [105.3125, -5.3590, 105.3155, -5.3575], # Depan ITERA
